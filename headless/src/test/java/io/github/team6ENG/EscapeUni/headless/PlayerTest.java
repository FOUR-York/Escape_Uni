...
public class PlayerTest extends AbstractHeadlessGdxTest {
    ...
    /**
     * Changing all the keys to be either pressed or not.
     *
     * @param KeyValue: pressed/not.
     */
    ...
    /**
     * Testing handleInput() with the following scenarios.
     * - both keys are pressed.
     * - only one key is pressed (vice versa)
     *
     * W and Up do the same thing.
     */
    @Test
    ...
    /**
     * Testing handleInput with invertControls.
     */
    @Test
    public void testInvertPlayerInput() {
        SetPlayerUp();
        playerTest.isInverted = true;

        int[] keyboardInputs = {Input.Keys.S, Input.Keys.DOWN, Input.Keys.W, Input.Keys.UP,
    ...
    /**
     * Testing handleInput when outOfBounds.
     */
    @Test
    public void testPlayerInvertedMovementOutOfBounds() {
        SetPlayerUp();
        playerTest.isInverted = true;
        ...
        int[] Inputs = {Input.Keys.DOWN, Input.Keys.UP, Input.Keys.LEFT, Input.Keys.RIGHT};
    ...
    /**
     * Testing that handleInput works appropriately when the character is out
     * of bounds, such as hitting a wall.
     */
    @Test
    ...
    /**
     * Checking that the Player inputSpeed changes if inWater.
     */
    @Test
    ...
    /**
     * Testing handleInput with different cells.
     */
    @Test
    ...
    /**
     * Testing handleInput with different cells, with inverted.
     */
    @Test
    public void testPlayerInvertedInputCells () {
        SetPlayerUp();
        playerTest.isInverted = true;
    ...
    /**
     * Testing the updatePlayer() function.
     */
    @Test
